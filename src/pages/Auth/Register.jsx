      ...
      <div className="flex items-center justify-center  min-h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${img})`, backgroundColor: "rgba(0, 0, 0, 0.6)"}}>
        ...
        <div className="lg:w-1/4 md:w-1/2 border border-[rgba(255,255,255, .2)] backdrop-blur-xl shadow-xl text-white bg-transparent font-[Poppins] p-8 rounded-xl">
          ...
          <div className="w-full my-4 mx-0 h-[50px] relative">
            <input onChange={handleInput} id="firstName" className="w-full h-full bg-transparent px-6 py-4 text-white text-md outline-none border-2 border-gray-200 rounded-[40px] placeholder:text-white" type="text" placeholder="First Name"/>
            <i className="bx text-white bxs-user absolute right-5 top-3 text-xl"></i>
          </div>
          <div className="w-full my-4 mx-0 h-[50px] relative">
            <input onChange={handleInput} id="lastName" className="w-full h-full bg-transparent px-6 py-4 text-white text-md outline-none border-2 border-gray-200 rounded-[40px] placeholder:text-white" type="text" placeholder="Last Name"/>
            <i className="bx text-white bxs-user absolute right-5 top-3 text-xl"></i>
          </div>
          <div className="w-full my-4 mx-0 h-[50px] relative">
          ...
          <div className="w-full my-4 mx-0 h-[50px] relative">
            <input onChange={handleInput} id="password" className="w-full h-full bg-transparent px-6 py-4 text-white text-md outline-none border-2 border-gray-200 rounded-[40px] placeholder:text-white" type={showPassword ? 'text' : 'password'} placeholder="Password"/>
          ...
          <div className="w-full my-4 mx-0 h-[50px] relative">
            <input onChange={handleInput} id="confirmPass" className="w-full h-full bg-transparent px-6 py-4 text-white text-md outline-none border-2 border-gray-200 rounded-[40px] placeholder:text-white" type={showPassConfirm ? 'text' : 'password'} placeholder="Password Confirmation"/>
